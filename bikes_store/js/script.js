...
(function () {
  ...
  (function () {
    if (!Element.prototype.closest) {
      Element.prototype.closest = function (css) {
        ...
        while (node) {
          if (node.matches(css)) return node;else nede = node.parentElement;
        }
  ...
  tabs();
  ;
  var colors = ['#1089ff', '#f00', '#de5216', '#00FF00', '#30D5C8', '#ff69b4', '#ff69b4', '#f00', '#00BFFF', '#00FF00', '#f00', '#1089ff']; // $('.js-product-prev__slider img').each(function (index, el) {
